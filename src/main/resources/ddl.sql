...
create table item_pedido (id bigint not null auto_increment, observacao varchar(255), preco_total integer, preco_unitario decimal(19,2), quantidade integer, pedido_id bigint not null, produto_id bigint not null, primary key (id)) engine=InnoDB;
...
create table produto (id bigint not null auto_increment, ativo bit not null, descricao varchar(255) not null, nome varchar(255) not null, preco decimal(19,2) not null, id_restaurante bigint, primary key (id)) engine=InnoDB;
create table restaurante (id bigint not null auto_increment, data_atualizacao datetime(6) not null, data_cadastro datetime(6) not null, endereco_bairro varchar(255), endereco_cep varchar(255), endereco_complemento varchar(255), endereco_logradouro varchar(255), endereco_numero varchar(255), nome varchar(255) not null, taxa_frete decimal(19,2) not null, id_cozinha bigint not null, endereco_cidade_id bigint, primary key (id)) engine=InnoDB;
create table restaurnte_forma_pagamento (restaurante_id bigint not null, forma_pagamento_id bigint not null) engine=InnoDB;
...
alter table produto add constraint FKi9wilbw69bh3m9rw7xs7sqmah foreign key (id_restaurante) references restaurante (id);
alter table restaurante add constraint FKs0dxabd90oowkwaqh42dkbfxi foreign key (id_cozinha) references cozinha (id);
alter table restaurante add constraint FKbc0tm7hnvc96d8e7e2ulb05yw foreign key (endereco_cidade_id) references cidade (id);
alter table restaurnte_forma_pagamento add constraint FKsa2fj8610ahnv9qckk8c9rah0 foreign key (forma_pagamento_id) references forma_pagamento (id);
alter table restaurnte_forma_pagamento add constraint FKi82v5gj1ct5a35w0oudesnyll foreign key (restaurante_id) references restaurante (id);
